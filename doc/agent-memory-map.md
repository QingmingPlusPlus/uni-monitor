...
| `src/components/css-map`、`SpriteCssMapPanel`、`public/factory-map`、`src/static/factory-map`、`css-map` 厂区地图 | `doc/factory-dimensions.md`、`doc/factory-dashboard-real-data-mapping.md`、`DESIGN.md` | - | - | 更新工厂维度 doc、接口映射 doc、设计系统或地图组件 | 生效 |
