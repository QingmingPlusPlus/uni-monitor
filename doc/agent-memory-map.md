...
| `src/pages/factory-dashboard/data/factoryDashboardLoader.ts`、部门/工序维度首页真实接口适配 | `doc/factory-dashboard-real-data-mapping.md`、`doc/department-api-gaps.md`、`doc/factory-dimensions.md` | - | - | 更新接口映射 doc、接口缺口 doc 或工厂维度 doc；若新增/调整 loader 子模块，同步更新映射 doc 中的入口说明 | 生效 |
