...
最新契约快照见 [2026-09-16 Swagger 核对](swagger-contract-review.md)，其中接入状态以当前代码及本文为准。变化点统计卡已通过 `dept/process/progress` 查询，保留非设备关联记录；地图已读取新字段，但无参数查询仍待适配。统计口径见 [变化点统计](change-point-statistics.md)。
