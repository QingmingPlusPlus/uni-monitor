...
- Sprite 设备卡片不超出设备原始占位；小尺寸设备允许名称省略，放大或聚焦后在同一占位内显示完整名称。细长纵向设备会扩大顶部信息区，名称在最多三行内自动缩小字号，状态使用整行宽度并自动适配字号，避免长设备名和“异常停止/计划停止”等工况被截断；人员配置与 5M 标记在此布局中采用更紧凑的标签和标记尺寸。人员配置使用班次扇形标记，5M 使用“人/机/料/法/环”方块标记，均由独立 Canvas 渲染模块封装。
