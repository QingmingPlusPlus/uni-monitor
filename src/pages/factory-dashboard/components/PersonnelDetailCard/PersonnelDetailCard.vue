<template>
  <view class="personnel-detail-card">
    <view class="personnel-detail-card__head">
      <view class="personnel-detail-card__title-group">
        <text class="personnel-detail-card__title">{{ data.title }}</text>
...
<style scoped src="./PersonnelDetailCard.css"></style>
